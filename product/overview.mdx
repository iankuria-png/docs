...
<Warning>
  Package tiers, features, and pricing are **owned by the CS Team**. If an escort asks you to change a price, create a new tier, or grant a discount beyond the approved threshold — escalate to your manager. Do not contact IT Infrastructure for pricing changes.
</Warning>
...
<AccordionGroup>
  ...
  <Accordion title="RD Team — what you own" icon="lightbulb">
    | Area | Responsibility |
    | --- | --- |
    | Product Maintenance | Maintain, Update and Upgrade Plattforms |
    | Exotic Chat | Product roadmap and launch timeline for native messaging app |
  </Accordion>

  <Accordion title="SEO, RD & IT Infrastructure — what you own" icon="server">
    | Area | Responsibility |
    | --- | --- |
