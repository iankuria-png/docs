...
<Tabs>
  <Tab title="Follow the journey">
    Read Stages 1 → 8 in order if you are new. This gives you the full escort experience from discovery to renewal and upgrade.
  </Tab>
  <Tab title="Troubleshoot fast">
    Jump straight to Stage 5c, 5d, 5e, 6, or 7 when the question is operational: payment not confirmed, profile not live, no calls, renewal risk, or traffic-related complaints.
  </Tab>
  <Tab title="Coach by function">
    Use the department notes on each page to coach Sales & CS, Finance, R&D/Product, IT Infrastructure, and SEO & Marketing on exactly what they own at that point in the lifecycle.
  </Tab>
</Tabs>
