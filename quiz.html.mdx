...
export const questions = [
  {
    ...
    correct: 2,
    explanation: "Referrals convert fastest because trust is already present before the first call.",
  },
  {
    stage: "Stage 1 — Discover",
    ...
    correct: 1,
    explanation: "Standard practice is 3 contact attempts over 7 days.",
  },
  {
    ...
    correct: 2,
    explanation: "New profiles stay private until verification and subscription activation are complete.",
  },
  {
    stage: "Stage 2 — Register",
  ...
  },
  {
    ...
    correct: 1,
    explanation: "No packages usually means no active `subscription_push` provider binding.",
  },
  {
    ...
    correct: 2,
    explanation: "A payment link can be opened and paid from any supported device or number.",
  },
  {
    ...
    correct: 2,
    explanation: "Completed payment plus pending deal usually means provisioning failed or stalled.",
  },
  {
    stage: "Stage 5c — Confirmation",
  ...
  },
  {
    ...
    correct: 2,
    explanation: "The payment reached the CRM but could not be matched to a client record automatically.",
  },
  {
    stage: "Stage 5e — Failures",
  ...
  },
  {
    ...
    correct: 1,
    explanation: "This is usually a visibility or profile-quality issue, not a channel failure.",
  },
  {
    stage: "Stage 6 — Contact",
    ...
    correct: 2,
    explanation: "Exotic Chat is being positioned as a company-to-escort communication channel, not the public visitor contact method.",
  },
  {
    ...
    correct: 1,
    explanation: "Expiry hides the profile but preserves the data for fast renewal recovery.",
  },
  {
  ...
  {
    stage: "Cross-stage — Departments",
    text: "Which department owns package tiers, pricing, and the decision to open new African markets?",
    options: [
      "RD Team & IT Infrastructure",
      "Sales & CS",
      "Finance",
    ...
    correct: 0,
    explanation: "Within the combined function, RD owns the product decisions while IT Infrastructure executes the technical rollout.",
  },
];
  ...
  if (!started) {
    return (
      <div style={{ border: "1px solid #e5e7eb", borderRadius: "16px", padding: "24px", background: "#fff" }}>
        <h2 style={{ marginTop: 0 }}>Certification Quiz</h2>
        <p>20 questions across the full escort lifecycle. Score 80% or above to pass.</p>
  ...
  if (!finished) {
    ...
    return (
      <div style={{ border: "1px solid #e5e7eb", borderRadius: "16px", padding: "24px", background: "#fff" }}>
        ...
        <h2 style={{ marginTop: "8px" }}>{currentQuestion.text}</h2>
  ...
  return (
    <div style={{ display: "grid", gap: "20px" }}>
      <div style={{ border: "1px solid #e5e7eb", borderRadius: "16px", padding: "24px", background: "#fff" }}>
        ...
        <p>{passed ? "You passed the certification quiz." : "You need 80% or above to pass. Review the answers below and try again."}</p>
        <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", marginTop: "16px" }}>
          <button
            onClick={resetQuiz}
            style={{ background: "#111827", color: "#fff", border: 0, borderRadius: "999px", padding: "12px 18px", fontWeight: 700 }}
          >
            Retake quiz
          </button>
        </div>
      ...
      {passed && (
        <div style={{ border: "2px solid #fc2c24", borderRadius: "16px", padding: "28px", background: "#fff" }}>
        ...
        <div style={{ border: "1px solid #e5e7eb", borderRadius: "16px", padding: "24px", background: "#fff" }}>
          ...
          <div style={{ display: "grid", gap: "14px" }}>
            {wrongAnswers.map((item, reviewIndex) => (
              <div key={`${item.question.text}-${reviewIndex}`} style={{ padding: "14px 16px", borderRadius: "12px", background: "#f9fafb" }}>
...
<Info>
  This quiz is served as a Mintlify page so it deploys with the docs site and does not rely on separate static HTML routing.
</Info>
